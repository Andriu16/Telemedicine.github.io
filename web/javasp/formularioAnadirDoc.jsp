            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="fw-bold" style="color:black">Registro de Doctor</h1>                       
                    </div>

                    <!-- <h2>Section title</h2>-->
                    <form action="../registerMedico" method='POST'enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="hidden" class="form-control"  id="txtIDCargo" name="txtIDCargo" value="2">>
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1"><label class="fw-bold">Codigo de Especialidad</label></span>
                            <input type="text" class="form-control" placeholder="1-7" id="txtEspecialidad" name="txtEspecialidad" required="">
